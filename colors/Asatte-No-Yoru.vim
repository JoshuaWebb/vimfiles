...
let s:background = "21252a"
let s:selection = "474747"
let s:line = "21252a"
...
let s:white = "eeeeee"
let s:mid_grey = "666666"
let s:black = "000000"
let s:brightred = "c83838"
let s:brightyellow = "ffdf5f"

hi clear
syntax reset

" 明後日の夜
let g:colors_name = "Asatte-No-Yoru"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Error", s:white, s:brightred, "bold")
	call <SID>X("ErrorMsg", s:white, s:brightred, "bold")
	call <SID>X("LineNr", s:selection, "", "")
	call <SID>X("NonText", s:selection, "", "")
	call <SID>X("SpecialKey", s:selection, "", "")
	call <SID>X("Search", s:background, s:brightyellow, "")
	...
	call <SID>X("MatchParen", s:background, s:mid_grey, "none")
	call <SID>X("Folded", s:comment, s:background, "")
	call <SID>X("FoldColumn", "", s:background, "")
	if version >= 700
		call <SID>X("CursorLineNr", s:brightyellow, "", "none")
	...
	call <SID>X("Todo", s:brightyellow, s:background, "")
	...
	call <SID>X("diffChange", s:background, "fbab60", "")
